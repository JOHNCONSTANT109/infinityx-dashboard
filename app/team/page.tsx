  ...
  const TEAM = [
    {
      ...
      avatar: "👑",
      description:
        "Founder of INFINITYX and the creative force behind the platform. Built the entire bot and dashboard from the ground up — from the Pokémon engine to the web platform.",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="glass-card p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">INFINITYX</h3>
            ...
            <div className="glass-card p-8 text-center border border-[#2a2f45]">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="https://chat.whatsapp.com/IRmpfS9vTTK3mRE7VLOgdF" target="_blank" rel="noopener noreferrer">
